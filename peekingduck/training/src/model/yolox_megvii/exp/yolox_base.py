...
class Exp(BaseExp):
    ...
    def get_model(self):
        from src.model.yolox_megvii.models import YOLOX, YOLOPAFPN, YOLOXHead
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from src.model.yolox_megvii.utils import LRScheduler
    ...
    def get_trainer(self, args):
        from src.model.yolox_megvii.core import Trainer
