...
from peekingduck.nodes.model.yolov6_core.layers.dbb_transforms import *
...
class DBBBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, n=1):
        ...
        self.block = (
            nn.Sequential(
                *(DiverseBranchBlock(out_channels, out_channels) for _ in range(n - 1))
            )
            if n > 1
            else None
        )
