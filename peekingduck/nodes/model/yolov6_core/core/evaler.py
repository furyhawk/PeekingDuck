...
from yolov6_core.data.data_load import create_dataloader
from yolov6_core.utils.events import LOGGER, NCOLS
from yolov6_core.utils.nms import non_max_suppression
from yolov6_core.utils.checkpoint import load_checkpoint
from yolov6_core.utils.torch_utils import time_sync, get_model_info
...
class Evaler:
    ...
    def init_model(self, model, weights, task):
        if task != 'train':
            ...
            # switch to deploy
            from yolov6_core.layers.common import RepVGGBlock
